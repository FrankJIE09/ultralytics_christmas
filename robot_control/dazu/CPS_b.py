...
class CPSClient(object):
    ...
    *	@param return: 错误码
    ...
    def moveJ_robot(self, target_joint, boxID=0, rbtID=0, speed=50, acceleration=500, radius=0, isJoint=1):
        """
        通过关节插补方式移动机器人到目标位姿。
...
if __name__ == '__main__':
    ...
    target_pose[3:6] = [180, 0, 18]
    client.move_robot(target_pose=[13.347, 540.737, 741.392, -27.172, -11.204, -23.275])

    client.moveJ_robot(target_joint)
